       ...
       <tbody>
        ...
        while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
          ...
          <tr>
            ...
            <td>
            <a href="ubah_proses.php?id_transaksi=<?=$data_transaksi['id_transaksi'] ?>" style="color: #858796">Proses</a> | 
            <a href="ubah_selesai.php?id_transaksi=<?=$data_transaksi['id_transaksi']?>" style="color: #858796">Selesai</a> | 
            <a href="ubah_diambil.php?id_transaksi=<?=$data_transaksi['id_transaksi']?>" style="color: #858796">Diambil</a>
            <style>
                a:link{
                    color: black;
